...
ORIGINAL https://codepen.io/jackrugile/pen/bGRWbK
...
(function(){ 'use strict';
  ...
  StatePlay.prototype.init = function() {
    this.scoreElem = document.querySelector( '.scoreCur' );
    ...
    if (localStorage.getItem("scoreHigh") == null) {
      localStorage.setItem("scoreHigh", this.score);
    }
    document.querySelector( '.scoreHigh' ).innerHTML = localStorage.getItem("scoreHigh");
  };
  ...
  StatePlay.prototype.keydown = function( e ) {
    ...
    if( e === 80 ) { _this.pauseGame = !_this.pauseGame; }
  };
  ...
  StatePlay.prototype.exit = function() {
    ...
    this.time = null;
    if (this.score > localStorage.getItem("scoreHigh")) {
      localStorage.setItem("scoreHigh", this.score)
    }
  };
