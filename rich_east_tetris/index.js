// ORIGINAL https://codepen.io/REast/pen/bGMyqP
...
var Page = {  
  ...
  var GM = {
    ...
    Initialize: function(){
      ...
      if (localStorage.getItem("ScoreHigh") == null) {
        localStorage.setItem("ScoreHigh", this.ScoreHigh);
      } else {
        this.ScoreHigh = localStorage.getItem("ScoreHigh");
      }
    },
  ...
  document.addEventListener('touchmove', function(event) {
    ...
    // console.log(`translate(${currentX - startX}px, ${currentY - startY}px)`);
  });
