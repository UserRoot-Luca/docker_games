...
Area = (function() {
  ...
  load_cards = function(cards_version) {
    var _this = this;
    return d3.json('src/js/cards.json', function(e, obj) {
      if (e) {
    ...
    _fn = function(item) {
      ...
      if (url == null) {
        if (item === "language") {
          ...
          if (_this.selector[item].select('option[value="src/lang/#{lang}.json"]').empty()) {
            lang = "en";
          }
          url = "src/lang/" + lang.substring(0, 2) + ".json";
        } else {
